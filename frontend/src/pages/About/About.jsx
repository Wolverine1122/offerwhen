  ...
  return (
    <div className="about">
      ...
      <div className="about-text">
        <p>As a CS major myself, I have lurked (and still do) in many CS subreddits and discord servers.</p>
        <p>It has been quite helpful being in a community of self-driven TC chasers and realizing that I can do it too.</p>
        <p>Before creating this webapp, I used to check process-tracking channels and ask questions from other applicants how they performed on OAs and interviews.</p>
